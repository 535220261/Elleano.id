<section class="footer flex">
    <div class="footer-logo">
        ...
        <p class="fs-montserrat fs-200">
                Elleano.id adalah brand fashion yang mengutamakan kenyamanan dan kesesuaian ukuran untuk wanita bertubuh kecil (petite), dengan fokus menciptakan pakaian yang pas dan nyaman dipakai.
